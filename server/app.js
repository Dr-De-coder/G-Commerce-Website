...
app.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            return res.status(400).json.send(`Webhook Error: ${error.message || error}`);
        }
        ...
        if (event.type === "payment_intent.succeeded") {
            ...
            try {
                ...
                const paymentTableUpdateReult = await database.query(
                ...
                //Reduce stock for Eact Product
                const orderId = paymentTableUpdateReult.rows[0].order_id;
