...
export const placeNewOrder = catchAsyncErrors(async (req, res, next) => {
    ...
    if(
        ...
        return next(
            new ErrorHandler("please provide shipping details.",400)
        );
    }
    ...
    await database.query(
        ...
        VALUES ${placeholders.json(", ")} RETURNING*
        `,
        values
    );
    ...
    const PaymentResponse = await generatePaymentIntent(order_id, total_price);
